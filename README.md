...
# 2. Place the raw ADNI data files in CountdownParadox_Analysis/ADNI_2026_data/
...
| Script | Input | Output | Description |
| ------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------- |
| `create_manuscript_tables.R` | main\_results\_all\_biomarkers.csv, degeneracy\_all\_biomarkers.csv, table1\_demographics.csv | CountdownParadox\_Analysis/results/manuscript\_tables/\*.csv | Generates Tables 1-3 for the manuscript. All values read dynamically from upstream CSVs. |
...
| Raw ADNI data (CSV files, e.g. `DXSUM_*.csv`, `PTDEMOG_*.csv`) | User-provided | Place in `CountdownParadox_Analysis/ADNI_2026_data/` |
